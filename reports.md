...
Reports dashboard will have the recent report runs, left side, first option
...
You will see a list of recent audits runs
...
By selecting one, you will enter a dashboard with main details
...
Hovering over an item will return a description, you can also create an alert
